...
| **CAM**                     | Control Account Manager (Earned Value Management role; the Manufacturing Productivity Engineer may transition into this). |
...
| **TRL**                     | Technology Readiness Level – NASA/DoD scale used to assess maturity of leanVM and other components. |
| **TVM**                     | TON Virtual Machine (execution environment for FunC contracts). |
| **zk**                      | Zero-Knowledge – cryptographic proofs that reveal nothing beyond validity of a statement. |
| **zk-STARK**                | Zero-Knowledge Scalable Transparent Argument of Knowledge (the proof system used in PQ-NFT-USG). |
